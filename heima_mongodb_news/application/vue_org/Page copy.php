...
class Page {
    ...
    private function firstprev() {
        if ($this->page > 1) {
            $str = " <li><a href='javascript:;' url='{$this->uri}page=1'  onclick='pagejump(this)' aria-label=\"Previous\"><span aria-hidden=\"true\">{$this->config["first"]}</span></a></li> ";
            $str .= "<li><a href='javascript:;' url='{$this->uri}page=" . ($this->page - 1) . "' onclick='pagejump(this)' aria-label=\"Previous\"><span aria-hidden=\"true\">{$this->config["prev"]}</span></a></li> ";
            return $str;
        }
    }
    ...
    private function pageList() {
        ...
        for ($i = $inum; $i >= 1; $i--) {
            ...
            if ($page >= 1)
                ...
                $linkPage .= "<li><a href='javascript:void(0);' url='{$this->uri}page={$page}' onclick='pagejump(this)'>{$page}</a></li> ";
        }
        /*当前页的信息 */
        if ($this->pageNum > 1)
    ...
    private function nextlast() {
        if ($this->page != $this->pageNum) {
            $str = " <li><a href='javascript:;' url='{$this->uri}page=" . ($this->page + 1) . "' onclick='pagejump(this)' aria-label=\"Next\"><span aria-hidden=\"true\">{$this->config["next"]}</span></a></li> ";
            $str .= " <li><a href='javascript:;' url='{$this->uri}page=" . ($this->pageNum) . "' onclick='pagejump(this)' aria-label=\"Next\"><span aria-hidden=\"true\">{$this->config["last"]}</span></a></li> ";
            return $str;
        }
    }
